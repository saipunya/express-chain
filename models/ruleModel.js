...
// Fetch rules with pagination and optional search
...
exports.insertRule = async (data) => {
    const { rule_code, rule_name, rule_type, rule_year, er_no, rule_file, rule_saveby, rule_savedate } = data;
    const [result] = await db.query(
...
// Fetch the latest uploads with a limit
